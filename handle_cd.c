/**
 * update_dir_env - function that updates the OLDPWD and PWD env variables.
 * @var_name: name of environment variable.
 * @new_value: value it will be updated to.
 * @env: list of environment variables
 * @parent_name: name of calliong process.
 * Return: void.
 */
...
/**
 * last_condition - function that runs last condition.
...
/**
 * handle_cd - function that handlees the builtin commands.
 * @argv: list of all arguments
 * @env - list of environment variables.
 * @parent_namr: name of calling process.
 * Return:void
 */
